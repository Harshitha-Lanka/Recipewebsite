...
const Idly = () => {
  ...
  <div className={styles.bigline}>
    ...
    <h4>Servings :4</h4>
    <h4>Preparation Time: 10hours including soaking and fermentation time</h4>
    <h4>Cooking time:15mins</h4>
    </div>
   
    <h2 className={styles.ingu}>Ingredients</h2>
 
    <ol className={styles.list}>
      <li>1 cup parboiled rice (Idli rice)</li>
<li>1 cup split urad dal (black gram)</li>
<li>½ teaspoon fenugreek seeds</li>
<li>Salt to taste</li>
<li>Water as required</li>
<li>Oil for greasing the idli molds</li>
<li>Instructions:</li>
    </ol>
    <h2 className={styles.stepu}>Steps:</h2>
    <div>
   <p className={styles.soak}> <b>Soak the Ingredients:</b>
